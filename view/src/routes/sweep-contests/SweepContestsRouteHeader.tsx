...
const MSG = 'Run a sweep contest for your collection';

export const SweepContestsRouteHeader = () => {
        ...
        <>
            ...
            >
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', marginBottom: isMobile ? 0 : '16px' }}>
                    <PrimaryButton onClick={() => setLocation(RoutePath.SweepContestsCreate)}>
                        Create Sweep Contest
                    </PrimaryButton>
                </Box>
            </Box>
        </>

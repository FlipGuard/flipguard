...
export const VerifiedWalletDialog = ({ sweepContestId, participant, open, onClose }: Props) => {
    ...
    const onUnverify = () => {
        setWalletStatusMutation.mutate(
            ...
            },
            {
                onSettled: onClose,
                onSuccess: () => {
                    displaySuccessToast('Wallet has been unverified');
                },
            },
        );
    };
    ...
    return (
        ...
        >
            ...
            >
                ...
                <TertiaryButton loading={setWalletStatusMutation.isLoading} onClick={onUnverify}>
                    Unverify
                </TertiaryButton>
            </DialogActions>
        </CustomDialog>

...
const DESCRIPTION = 'Showcase NFT rarity information directly on your Discord server';

export const DiscordRarityBotRouteHeader = () => {
            ...
            >
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', marginBottom: isMobile ? 0 : '16px' }}>
                    <PrimaryButton
                        ...
                        onClick={() =>
                            window.open('https://wiki.flipguard.xyz/flipguard-wiki-wip/discord-bots/rarity-bot')
                        }
                    >
                        Setup Guide

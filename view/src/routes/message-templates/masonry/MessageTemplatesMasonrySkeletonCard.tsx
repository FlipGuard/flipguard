...
export const MessageTemplatesMasonrySkeletonCard = () => {
    return (
        <Card sx={{ padding: '4px' }}>
            ...
            <CardContent sx={{ marginBottom: '-20px' }}>
                <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'start', marginTop: '12px' }}>
                    <Skeleton sx={{ height: '320px', width: '100%', marginBottom: '8px' }} variant={'rounded'} />
                </Box>
            </CardContent>
            <CardContent sx={{ marginBottom: '-12px' }}>
                <Box sx={{ display: 'flex', alignItems: 'start', marginTop: '12px' }}>
                    <Skeleton
                        sx={{ height: '28px', width: oneOf([75, 100], 'px'), borderRadius: '16px', marginRight: '8px' }}
                        variant={'rounded'}
                    />
                    <Skeleton

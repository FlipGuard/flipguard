...
const DESCRIPTION = 'Customize messages sent by your bots';

export const MessageTemplatesRouteHeader = () => {
        ...
        <>
            ...
            >
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', marginBottom: isMobile ? 0 : '16px' }}>
                    <PrimaryButton onClick={() => setLocation(RoutePath.MessageTemplatesAdd)}>
                        Create Template
                    </PrimaryButton>
                </Box>
            </Box>

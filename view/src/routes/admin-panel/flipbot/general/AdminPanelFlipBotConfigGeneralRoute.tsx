...
import { AdminPanelFlipBotGeneralSettingsCard } from './GeneralSettingsCard';

export const AdminPanelFlipBotConfigGeneralRoute = () => {
    ...
    return (
        <Grid item xs={12} md={12} lg={10} xl={10}>
            <AdminPanelFlipBotGeneralSettingsCard settings={globalSettings} />
        </Grid>
    );
};

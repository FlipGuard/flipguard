...
export const AddRumbleRewardDialog = ({ isOpen, onClose, onAdd }: Props) => {
        ...
        >
            ...
            <DialogContent sx={{ padding: 0, display: 'flex', flexDirection: 'column' }}>
                <CustomSelect
                    ...
                    label={'Reward type'}
                    options={[
                        { label: 'Manual', value: DiscordItemType.CUSTOM },
                        { label: 'Role', value: DiscordItemType.ROLE },
                        { label: 'Token', value: DiscordItemType.TOKEN },
                        { label: 'NFT', value: DiscordItemType.NFT },
                    ]}
                    value={type}

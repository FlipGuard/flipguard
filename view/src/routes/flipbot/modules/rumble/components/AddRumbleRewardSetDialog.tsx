import { RumbleRewardSet } from '@flipguard/webapp-api';
...
type Props = {
    ...
    isOpen: boolean;
    onClose: () => void;
    onAdd: (value: Pick<RumbleRewardSet, 'name'>) => void;
};

export const AddRumbleRewardSetDialog = ({ reservedNames, isOpen, onClose, onAdd }: Props) => {
    ...
    const error = reservedNames.includes(name) ? 'This reward set name is already taken' : undefined;
